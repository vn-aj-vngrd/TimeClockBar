...
- [x] Commit and push `396285a`; build, signature-verify, replace the previous installed app, and open **1.2.6, build 40** at `~/Applications/Time Clock Bar.app`. Confirm installed metadata and running executable with `--show-today`; settings and website data preserved.
- [x] Package SHA-256: `6f32307f314c407c7f05c60ba4eaaee0403213bdc74d48501a7d65ac4c40afe2`. Install log: `/tmp/timeclock-v126-install.log`. Installed runtime verified `Clock observation recovered: clockedOut` at 01:47:31; evidence: `/tmp/timeclock-v126-runtime.log`.
...
- [x] Commit and push `dc72366`; build, signature-verify, replace the old app, and open **1.2.9, build 48** at `~/Applications/Time Clock Bar.app`. Installed metadata and running executable with `--show-today` verified; settings and website data preserved.
- [x] Package SHA-256: `2d40d11883c80e3c1cfa4905db0a1e1cd616834254e844e658afc75bb37032ef`. Install log: `/tmp/timeclock-v129-recorded-install.log`. Installed runtime confirmed **three recorded attendance dates available** and active state at 21:17:38; categorical evidence: `/tmp/timeclock-v129-recorded-runtime.log`. This verifies live extraction, not a native visual comparison of individual values.
